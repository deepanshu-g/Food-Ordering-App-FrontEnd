  ...
  render(){
    return (
      <Switch>
        ...
        <Route exact path='/details/:restaurantId' render={({history}, props) => <Details {...props} history={history} restaurantId={this.state.restaurantId} addItems={this.addItem} setCartTotal={this.setCartTotal}/>} />
